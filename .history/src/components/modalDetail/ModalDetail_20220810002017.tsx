...
class ModalDetail extends Component<ModalDetailProps, ModalDetailStates> {
  ...
  render() {
    return (
      <>
        <Modal title={this.state.student?.MSSV === undefined ? "Thêm sinh viên" : "Cập nhật thông tin sinh viên"} visible={this.state.isModalVisible} onOk={() => this.saveItem()} onCancel={() => this.handleCancel()}>
